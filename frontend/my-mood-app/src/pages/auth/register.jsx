      ...
      <div className="registration-content">
        ...
        <div className="brain-illustration">
          <div className="brain-container">
            ...
            {/* Achievement Icons */}
            <div className="achievement-icon icon-1">⭐</div>
            <div className="achievement-icon icon-2">💰</div>
            <div className="achievement-icon icon-3">✓</div>
            <div className="achievement-icon icon-4">♥</div>
            <div className="achievement-icon icon-5">🧠</div>
            <div className="achievement-icon icon-6">🎯</div>
